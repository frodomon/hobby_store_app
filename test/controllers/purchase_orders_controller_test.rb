...
class PurchaseOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase_order" do
    assert_difference('PurchaseOrder.count') do
      post purchase_orders_url, params: { purchase_order: { ammount: @purchase_order.ammount, delivery_date: @purchase_order.delivery_date, order_date: @purchase_order.order_date, registered: @purchase_order.registered, supplier_id: @purchase_order.supplier_id, user_id: @purchase_order.user_id } }
    end
  ...
  test "should update purchase_order" do
    patch purchase_order_url(@purchase_order), params: { purchase_order: { ammount: @purchase_order.ammount, delivery_date: @purchase_order.delivery_date, order_date: @purchase_order.order_date, registered: @purchase_order.registered, supplier_id: @purchase_order.supplier_id, user_id: @purchase_order.user_id } }
