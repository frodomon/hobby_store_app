class SubCategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sub_category.save
        format.html { 
          flash[:notice] = 'La sub categoría se creó satisfactoriamente.'
  ...
  def update
    respond_to do |format|
      if @sub_category.update(sub_category_params)
        format.html { 
          flash[:notice] = 'La sub categoría se actualizó satisfactoriamente.'
          redirect_to sub_categories_path
        }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { 
        flash[:notice] = 'La sub categoría se eliminó satisfactoriamente.'
        redirect_to sub_categories_path
      }
