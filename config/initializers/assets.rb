...
Rails.application.config.assets.precompile += %w( user.js suppliers.css suppliers.js store_credits.css store_credits.js purchase_orders.css purchase_orders.js sales_orders.css sales_orders.js)
