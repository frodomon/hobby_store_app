...
Rails.application.config.assets.precompile += %w( 'appviews.css', 'cssanimations.css', 'dashboards.css', 'forms.css', 'gallery.css', 'graphs.css', 'mailbox.css', 'miscellaneous.css', 'pages.css', 'tables.css','widgets.css', 'commerce.css')
