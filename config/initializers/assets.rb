...
Rails.application.config.assets.precompile += %w( user.css addresses.css addresses.js products.css products.js warehouses.css warehouses.js inventories.css inventories.js ubigeos.css ubigeos.js )
Rails.application.config.assets.precompile += %w( new_user.js edit_user.js suppliers.css suppliers.js store_credits.css store_credits.js purchase_orders.css purchase_orders.js sales_orders.css sales_orders.js)
