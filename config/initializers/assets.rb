...
Rails.application.config.assets.precompile += %w( tickets.css user.css addresses.css addresses.js products.css products.js warehouses.css warehouses.js inventories.css inventories.js ubigeos.css ubigeos.js )
